...
<div class="card bg-dark" style="border:none">
    <article class="card-body mx-auto" style="max-width: 500px;">
        <h4 class="card-title mt-3 text-light text-center">Create Blog-post</h4>
        ...
        <form action="sign" method="POST">
            ...
            <div class="form-group input-group">
                ...
                <input name="Post" class="form-control" placeholder="Post" type="text">
            </div> <!-- form-group// -->
            <div class="form-group input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
            ...
            <div class="form-group ">
                <button type="submit" class="btn btn-primary text-light btn-block"> Create Post</button>
            </div> <!-- form-group// -->
